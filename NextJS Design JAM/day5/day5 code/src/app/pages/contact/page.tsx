    ...
    <div>
      ...
      <section>
        <div className="text-center mx-auto my-10">
          ...
          <h3 className="mx-auto mt-4 lg:w-[580px] text-[#9F9F9F]">
        ...
        <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-14 sm:mx-32 lg:mx-40">
              ...
              <ul>
                ...
                <li className="flex items-center text-[20px]">
                  <a
                    ...
                    className="text-black text-sm ml-14 w-[200px]"
                  >
                ...
                <li className="flex items-center">
                  <a
                    href="javascript:void(0)"
                    className="text-black text-sm ml-14"
                  >
                    Mobile: +(84) 546-6789
                  </a>
                </li>
                ...
                <div className="flex mt-14">
                  ...
                  <h3 className="text-[22px] ml-8 font-semibold">
                    Working Time
                  </h3>
                </div>
                <li className="flex items-center">
            ...
            <div className="mt-6">
              <form className="mt-4 space-y-6">
                ...
                <input
                  type="text"
                  placeholder="abc"
                  className="w-full rounded-md border py-3 px-4 text-gray-800 text-sm outline-[#a91079]"
                />
                <br />
                <br />
                ...
                <textarea
                  ...
                  className="w-full rounded-md border px-4 text-gray-800 text-sm pt-3 outline-[#a91079]"
                ></textarea>
                <button
                  type="button"
